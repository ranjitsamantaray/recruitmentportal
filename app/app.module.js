...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            { provide: Summary_service_1.SummaryMethods, useClass: Summary_service_1.SummaryService }, { provide: Employee_service_1.EmployeeMethods, useClass: Employee_service_1.EmployeeService }, auth_guard_1.AuthGuard].concat(angular2_jwt_1.AUTH_PROVIDERS, [config_service_1.ConfigService, { provide: core_1.APP_INITIALIZER,
