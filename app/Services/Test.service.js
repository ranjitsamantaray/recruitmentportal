...
var TestService = (function (_super) {
    ...
    TestService.prototype.saveTest = function (candidateID) {
        var _this = this;
    ...
    TestService.prototype.getTest = function (candidateID) {
        var _this = this;
...
var TestDummyService = (function (_super) {
    ...
    TestDummyService.prototype.getTest = function (candidateID) {
        return this._http.get(this.url, candidateID)
            .map(function (response) { return response.json(); })
            .do(function (data) { return console.log('All : ' + JSON.stringify(data)); })
            .catch(this.handleError);
